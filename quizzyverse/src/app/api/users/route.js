...
export async function GET(request, context) {
    ...
    try {
        ...
        const sqlGet = 'SELECT id, is_admin, username, country, email, xp, is_premium, daily_count,renewed_at FROM users;'
        const [mySqlGetResponse] = await pool.query(sqlGet, [])
        console.log(mySqlGetResponse);
